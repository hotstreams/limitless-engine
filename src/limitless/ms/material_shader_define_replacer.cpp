...
std::string MaterialShaderDefineReplacer::getVertexStreamDeclaration(const std::shared_ptr<VertexStream>& stream) {
    std::string stream_declaration;

    auto& input_type = stream->getInputType();
    auto& name_map = stream->getNameMappings();
...
std::string MaterialShaderDefineReplacer::getVertexStreamGettersDeclaration(const std::shared_ptr<VertexStream>& stream) {
...
std::string MaterialShaderDefineReplacer::getVertexContextDeclaration(const std::shared_ptr<VertexStream>& stream) {
...
std::string MaterialShaderDefineReplacer::getVertexContextCompute(const std::shared_ptr<VertexStream>& stream) {
...
std::string MaterialShaderDefineReplacer::getVertexContextInterfaceBlock(const std::shared_ptr<VertexStream>& stream) {
    std::string context;
    ...
    if (normal_mapping & normal_texture) {
        context += "mat3 TBN;\n";
    }
...
std::string MaterialShaderDefineReplacer::getVertexContextInterfaceBlockOut(const std::shared_ptr<VertexStream>& stream) {
    std::string context_out = "out _vertex_context {\n";

    context_out += getVertexContextInterfaceBlock(stream);
...
std::string MaterialShaderDefineReplacer::getVertexContextInterfaceBlockIn(const std::shared_ptr<VertexStream>& stream) {
