...
VertexArray& Limitless::fx::operator<<(VertexArray& vertex_array, const std::pair<SpriteParticle, const std::shared_ptr<Buffer>&>& attribute) noexcept {
    ...
    vertex_array.setAttribute<glm::vec4>(3, false, sizeof(SpriteParticle), (GLvoid*)offsetof(SpriteParticle, acceleration_lifetime), attribute.second);
    vertex_array.setAttribute<glm::vec4>(4, false, sizeof(SpriteParticle), (GLvoid*)offsetof(SpriteParticle, position_size), attribute.second);
    vertex_array.setAttribute<glm::vec4>(5, false, sizeof(SpriteParticle), (GLvoid*)offsetof(SpriteParticle, rotation_time), attribute.second);
...
VertexArray& Limitless::fx::operator<<(VertexArray& vertex_array, const std::pair<BeamParticleMapping, const std::shared_ptr<Buffer>&>& attribute) noexcept {
    ...
    vertex_array.setAttribute<glm::vec4>(4, false, sizeof(BeamParticleMapping), (GLvoid*)offsetof(BeamParticleMapping, acceleration_lifetime), attribute.second);
    vertex_array.setAttribute<glm::vec4>(5, false, sizeof(BeamParticleMapping), (GLvoid*)offsetof(BeamParticleMapping, rotation_time), attribute.second);
    vertex_array.setAttribute<glm::vec4>(6, false, sizeof(BeamParticleMapping), (GLvoid*)offsetof(BeamParticleMapping, velocity_size), attribute.second);
    vertex_array.setAttribute<glm::vec4>(7, false, sizeof(BeamParticleMapping), (GLvoid*)offsetof(BeamParticleMapping, uv_length), attribute.second);
