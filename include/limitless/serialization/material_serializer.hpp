...
namespace LimitlessEngine {
    ...
    private:
        void deserializeProperties(ByteBuffer& buffer, Assets& assets, MaterialBuilder& builder);
        void deserializeCustomUniforms(ByteBuffer& buffer, Assets& assets, CustomMaterialBuilder& builder);
    public:
        ByteBuffer serialize(const Material& material);
        std::shared_ptr<Material> deserialize(Assets& assets, ByteBuffer& buffer);
    };
