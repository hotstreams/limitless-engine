...
mat3 getVertexTBN(uint id) {
    return in_data[id].TBN;
}
    #else
vec3 getVertexNormal(uint id) {
    return in_data[id].normal;
}
    #endif
    #endif
