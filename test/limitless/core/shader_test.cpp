...
TEST_CASE("Loads simple shader without error") {
    ...
    {
        Shader shader = Shader{"../test/limitless/assets/shader1.vs", Shader::Type::Vertex};
...
TEST_CASE("Replaces version in shader") {
    ...
    {
        Shader shader = Shader{"../test/limitless/assets/shader2.vs", Shader::Type::Vertex};
...
TEST_CASE("Resolves include in shader") {
    ...
    {
        Shader shader = Shader{"../test/limitless/assets/shader4.vs", Shader::Type::Vertex};
...
TEST_CASE("Replaces key-line in shader") {
    ...
    {
        Shader shader = Shader{"../test/limitless/assets/shader6.vs", Shader::Type::Vertex};
...
TEST_CASE("Throw file not found") {
    ...
    {
        REQUIRE_THROWS_AS(Shader("../test/limitless/assets/3228.vs", Shader::Type::Vertex), shader_file_not_found);
...
TEST_CASE("Throw include not found") {
    ...
    {
        REQUIRE_THROWS_AS(Shader("../test/limitless/assets/shader7.vs", Shader::Type::Vertex), shader_include_not_found);
...
TEST_CASE("Throw shader_compilation_error") {
    ...
    {
        Shader shader = Shader{"../test/limitless/assets/shader8.vs", Shader::Type::Vertex};
...
TEST_CASE("Shader move ctor") {
    ...
    {
        Shader shader1 = Shader{"../test/limitless/assets/shader1.vs", Shader::Type::Vertex};
